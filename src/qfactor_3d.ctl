...
(define-param r1 .35)  ; outer radius / lattice parameter
(define-param r2 1)  ; inner radius / lattice parameter
(define-param r3 .45)
...
(define pad 2)
(define dpml 1)
(define-param h .75) ; height of slab in units of 'a'
...
; material properties
(define-param eps1 11.56)  ; permittivity of low index material
(define-param eps2 1)  ; permittivity of high index material
...
(set! geometry-lattice (make lattice (size sx0 sy0 sz0)))
...
(if no-struc?
   ...
   (list 
		(make block (center 0 0 0) 
                (size (+ sx0 (* 2 dpml)) (+ sy0 (* 2 dpml) (* 2 pad)) h)
                (material mat1))))
	(set! geometry 
			(append
				(list
					(make block (center 0 0 0) (size (+ sx0 (* 2 dpml)) (+ sy0 (* 2 pad) (* 2 dpml)) h) (material mat1)))
				(geometric-objects-lattice-duplicates
					(list 
						(make cylinder (center 0 0) (radius r1) (height h) (material mat2))
						(make cylinder (center 0 0) (radius r2) (height h) (material air))
						(make cylinder (center (/ dx 2) (/ dy 2)) (radius r1) (height h) (material mat2))
						(make cylinder (center (/ dx 2) (/ dy 2)) (radius r2) (height h) (material air))
						(make cylinder (center (/ dx 2) (/ dy -2)) (radius r1) (height h) (material mat2))
						(make cylinder (center (/ dx 2) (/ dy -2)) (radius r2) (height h) (material air))
						(make cylinder (center (/ dx -2) (/ dy 2)) (radius r1) (height h) (material mat2))
						(make cylinder (center (/ dx -2) (/ dy 2)) (radius r2) (height h) (material air))
				...
				(list 
					(make cylinder (center 0 0 0) (radius r3) (material air) (height h)))
				; line defect in center (missing row of melanosomes)
				; (geometric-object-duplicates (vector3 a 0) 0 12
	   ;      (make cylinder (center (+ (* -0.5 sx0) (/ dx 2)) 0) (radius r1) (height h)
	   ;            (material mat1)))
		)
	)
)
...
(set! geometry-lattice (make lattice (size (+ sx0 (* 2 dpml)) (+ sy0 (* dpml 2)) (+ sz0 (* 2 dpml)))))
...
; use this code to convert to movie:
; 	unix% h5topng output/hz-*.h5
; 	unix% convert output/hz-*.png movie-hz.gif
